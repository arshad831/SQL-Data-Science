...
(
  ...
  Implant_Chip_ID VARCHAR(36) NOT NULL,
  ...
  FOREIGN KEY (Primary_Color) REFERENCES Colors(Color),
  CHECK (Gender IN ('F', 'M')),
  UNIQUE (Implant_Chip_ID)
);
...
(
  ...
  FOREIGN KEY (Email) REFERENCES Staff (Email) ON UPDATE CASCADE,
  FOREIGN KEY (Role) REFERENCES Staff_Roles (Role)
);
...
(
  ...
  FOREIGN KEY (Adopter_Email) REFERENCES Persons (Email) ON UPDATE CASCADE,
...
(
  ...
  FOREIGN KEY (Name, Species) REFERENCES Animals (Name, Species),
  FOREIGN KEY (Email) REFERENCES Staff (Email) ON UPDATE CASCADE
);
